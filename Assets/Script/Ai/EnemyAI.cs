...
public class EnemyAI : MonoBehaviour
{
    ...
    [GUIColor("RGB(0, 1, 0)")]
    [Tooltip("Set the TransparantFX and Assign the Enemy Layer ")]
    [SerializeField] LayerMask targetLayer;

    [Tooltip("Assign bullet ")]
    [Required("Custom error message.")]
    [AssetSelector]
    [SerializeField] GameObject projectailPrefab;

    [PropertyTooltip("Assign bulletSpawn Point ")]
    [AssetSelector]
    ...
    [FoldoutGroup("Event")]
    [SerializeField] UnityEvent enterAttack;
    [FoldoutGroup("Event")]
    [SerializeField] UnityEvent enterDitectionRange;
